...
if __name__ == '__main__':
    dataset = D()
    x_train, y_train, x_test, y_test, num_users, num_movies = dataset.get_data1()
    model = MF(x_train, y_train, x_test, y_test, num_users, num_movies, k=5, alpha=0.01, beta=0.01, epochs=30, verbose=True)
